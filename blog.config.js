...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '我们无法成功的原因是 我们总在等待机会成本',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CDxiaodong', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '你好，世界', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.cdxiaodong.life', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'cdxiaodong@systemshell.org', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/cdxiaodong', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  FONT_URL: [
    ...
    'https://fonts.googleapis.com/css?family=Bree+Serif|Bungee+Shade'
  ],
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'CD‘s second night', // 站点描述，被notion中的页面描述覆盖
